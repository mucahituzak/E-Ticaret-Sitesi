      ...
      <Fragment>
        ...
        <Container>
          <Row className="px-0 my-5">
            ...
            <p>1635 Fraklin Street Montgomery, Near Sherwood Mall. AL 36104 <br></br>
            Email: Support@easylearningbd.com
            </p>
            <h5 className="footer-menu-title">SOCIAL LINK</h5>
            <a href="https://tr-tr.facebook.com/mucahit.uzak.9" target="_blank"><i className="fab m-1 h4 fa-facebook" ></i></a>
            <a href="https://www.instagram.com/mucahituzak/" target="_blank"><i className="fab m-1 h4 fa-instagram"></i></a>
            <a href="https://twitter.com/mucahituzak" target="_blank"><i className="fab m-1 h4 fa-twitter"></i></a>
            <a href=""><i className="fab m-1 h4 fa-snapchat"></i></a>
            </Col>
        ...
        <Container fluid={true} className="text-center m-0 pt-3 pb-1 bg-dark" > 
          <Container>
            <Row>
    <h6 className="text-white">© Easy Shop 2022</h6> 
            </Row>
          </Container>
        </Container>
        </div>
